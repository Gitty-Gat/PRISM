"""Generate posterior learning animation frames for expanded validation.

Outputs:
- results/REALDATA_EXPANDED_VALIDATION/videos/posterior_learning_frames/
- results/REALDATA_EXPANDED_VALIDATION/videos/posterior_learning.gif
...
def main():
    ...
    exp_id = pick_rep_exp()
    s = json.load(open(os.path.join(BASE, exp_id, "summary.json"), "r", encoding="utf-8"))
